...
$(".post-super").toggle(function(){
    $(".post-r-pans").show();
    $(this).children().addClass("icon-angle-up")
},function(){
    $(".post-r-pans").hide();
//    $(this).children().romoveClass("icon-angle-up")
})
...
$(".post-r-dl-hide dt input").click(function(){
    if($(this).attr("checked")){
...
$(".yp-r-nav-div a").live("click",function(){
    if($(this).siblings().css("display")=="none"){ 
        $(this).siblings().show(250);
    }else{
...
$(".center-box button").click(function(){
    $(this).parents(".box-show").hide();
})
